    ...
    <section class="content-header">
     ...
     <b>Inspector Details</b>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Inspector Details</li>
        </ol>
    </section>
    <!-- Main content -->
      <!-- Main content -->
            ...
            <div class="box-body">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <button class="btn btn-primary pull-right" data-toggle="modal" data-target="#addRetailer">Add Inspector</button>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr>
                                     ...
                                     @php($i=1)
                                      @foreach($supplier as $item)
                                        ...
                                        <td>{{$item->gmail}}</td>
                                        <td>{{$item->address}}</td>
                                        <td>                               <a href="{{URL::to('inspectorupdate/'.$item->id) }}">
                                       <span class="glyphicon glyphicon-edit">
                                          Update
                                       </span> </a></td>
                                       <td>
                                        <a href="{{URL::to('Inspectordelete/'.$item->id) }}">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="inspector_deatils" method="post" id="retailerreg" name="retailerreg" enctype="multipart/form-data">
